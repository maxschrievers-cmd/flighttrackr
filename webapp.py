...
def serialize_aircraft(flight: Any, latitude: float, longitude: float) -> dict[str, Any]:
    ...
    return {
        ...
        "distance_km": round(distance, 2), "bearing_deg": round(bearing, 1), "bearing_cardinal": compass(bearing),
        ...
        "registration": flight.registration, "aircraft_type": flight.aircraft_type,
        "aircraft_description": flight.aircraft_description, "operator": flight.operator,
        "origin": flight.origin, "destination": flight.destination,
        "source": flight.source, "position_age_seconds": flight.position_age_seconds,
        "freshness": flight.freshness, "quality_score": flight.quality_score,
    }
